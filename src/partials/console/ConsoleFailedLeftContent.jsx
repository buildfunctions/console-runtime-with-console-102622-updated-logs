...
function ConsoleFailedLeftContent() {
  return (
          ...
          <div className="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-4 md:space-y-3 -mx-4">
            ...
            <div>
              ...
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <Link className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="/console">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <Link className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="/new">
                    ...
                    <span className="text-sm font-medium text-indigo-100 hover:text-indigo-50">New</span>
                  </Link>
                </li>

                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <Link className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="/console/status">
                    <svg className="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2" viewBox="0 0 16 16">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <Link className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="/console/successful">
                    <svg className="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2" viewBox="0 0 16 16">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <Link className="flex items-center px-2.5 py-2 rounded whitespace-nowrap bg-gray-200" href="/console/failed">
                    <svg className="w-4 h-4 shrink-0 fill-current text-indigo-500 mr-2" viewBox="0 0 16 16">
                      <path d="M10 16h4c.6 0 1-.4 1-.998V6.016c0-.3-.1-.6-.4-.8L8.6.226c-.4-.3-.9-.3-1.3 0l-6 4.992c-.2.2-.3.5-.3.799v8.986C1 15.6 1.4 16 2 16h4c.6 0 1-.4 1-.998v-2.996h2v2.996c0 .599.4.998 1 .998Zm-4-5.99c-.6 0-1 .399-1 .998v2.995H3V6.515L8 2.32l5 4.194v7.488h-2v-2.995c0-.6-.4-.999-1-.999H6Z" />
                    </svg>
                    <span className="text-sm font-medium text-indigo-500">Failed</span>
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <Link className="flex items-center px-2.5 py-2 rounded whitespace-nowrap bg-black" href="/console">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <Link className="flex items-center px-2.5 py-2 rounded whitespace-nowrap">
              ...
              <div>
                <div className="text-xs font-semibold text-slate-400 uppercase mb-3">Access</div>
                  <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                    <li className="mr-0.5 md:mr-0 md:mb-0.5">
                      <Link className="flex items-center px-2.5 py-2 rounded whitespace-nowrap" href="/tokens" >
                        <svg className="w-3 h-3 shrink-0 fill-current text-emerald-500 mr-3" viewBox="0 0 12 12">
                          <path d="M6 10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 2A6 6 0 1 1 6 0a6 6 0 0 1 0 12Z" />
                        </svg>
...
export default ConsoleFailedLeftContent;
