...
import PlanetLogo from '../../components/Logos/PlanetLogo';
  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute mb-20 z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-[#171717] p-4 transition-all duration-200 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-64'
          }`}
      >
        {/* Sidebar header */}
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        <path
                          className={`fill-current text-slate-400 ${(pathname === '/' || pathname.includes('console')) && '!text-indigo-500'
                            }`}
                          d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                        />
                        <path
                          className={`fill-current text-slate-600 ${(pathname === '/' || pathname.includes('console')) && 'text-indigo-600'}`}
                          d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                        />
                        <path
                          className={`fill-current text-slate-400 ${(pathname === '/' || pathname.includes('console')) && 'text-indigo-200'}`}
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('messages') && 'bg-slate-900'}`}>
                <CustomLink
                  href="/logs"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('logs') && 'hover:text-slate-200'
                    }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        <path
                          className={`fill-current text-slate-600 ${pathname.includes('logs') && 'text-indigo-500'}`}
                          d="M16 13v4H8v-4H0l3-9h18l3 9h-8Z"
                        />
                        <path
                          className={`fill-current text-slate-400 ${pathname.includes('logs') && 'text-indigo-300'}`}
              ...
              {/* metrics */}
              <SidebarLinkGroup activecondition={pathname.includes('metrics')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('metrics') && 'hover:text-slate-200'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <circle
                                className={`fill-current text-slate-400 ${pathname.includes('metrics') && 'text-indigo-300'}`}
                                cx="18.5"
                                cy="5.5"
                                r="4.5"
                              />
                              <circle
                                className={`fill-current text-slate-600 ${pathname.includes('metrics') && 'text-indigo-500'}`}
                                cx="5.5"
                                cy="5.5"
                                r="4.5"
                              />
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Billing */}
              <SidebarLinkGroup activecondition={pathname.includes('billing')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        ...
                        <li className="mb-1 last:mb-0">
                          ...
                          <li className="mb-1 last:mb-0">
                            <CustomLink
                              href="/billing/transaction-details"
                              className={({ isActive }) =>
                                'block text-slate-400 hover:text-slate-200 transition duration-150 truncate ' + (isActive ? '!text-indigo-500' : '')
                              }
                            >
               ...
               <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tokens</span>
                  </div>
                </CustomLink>
              </li>
            </ul>
