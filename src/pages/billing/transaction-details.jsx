...
import TransactionsTable from '../../partials/billing/TransactionsTable02';
import TransactionPanel from '../../partials/billing/TransactionPanel';
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden bg-white">
        {/*  Site header */}
        <Header sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} projectsSidebarOpen={projectsSidebarOpen} setProjectsSidebarOpen={setProjectsSidebarOpen} />
